    ...
    public class LoadingScreen : MonoBehaviour
    {
        ...
        public static void LoadScene(string sceneName)
        {
            try
            {
                ...
                if (fcgHelper == false)
                {
                    instance.loadingProcess = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(sceneName);
        ...
        private void ProcessAsyncLoading()
        {
            if (processLoading == true && forceCanvasGroup == true)
            {
                ...
                if (canvasGroup.alpha >= 1)
                {
                    ...
                    instance.loadingProcess = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(sceneHelper);
                    instance.loadingProcess.allowSceneActivation = false;
